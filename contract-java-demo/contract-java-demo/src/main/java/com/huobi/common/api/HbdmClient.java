...
public class HbdmClient {
	...
	public static void main(String[] args) throws HttpException, IOException {
		 ...
		 */
		String api_key = "323f8ad0-31d45677-4cbc018c-mjlpdje3ld"; // huobi申请的apiKey,API调试过程中有问题或者有疑问可反馈微信号shaoxiaofeng1118
		String secret_key = "062335a6-169fd6a2-7f68e972-e0b6f"; // huobi申请的secretKey
...
//
//		// 获取合约最高限价和最低限价
//		String pricelimit = futureGetV1.futurePriceLimit("EOS", "quarter", "EOS190927");
...
//
//		// 获取市场最近成交记录
		String trade = futurePostV1.futureMarketDetailTrade("EOS_CQ", "1");
